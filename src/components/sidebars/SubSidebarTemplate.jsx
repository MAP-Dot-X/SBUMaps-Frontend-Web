...
const SubSidebarTemplate = ({ 
  ...
  const filteredOptions = options.filter(({ name, location }) =>
          ...
          <li
            ...
            className={`flex items-center justify-between p-4 border rounded-lg shadow-sm cursor-pointer transition-transform ease-in-out duration-300 ${
              toggleStates[index]
                ...
                : 'hover:bg-red-800 hover:text-white hover:scale-105'
            }`}
...
export default SubSidebarTemplate;
